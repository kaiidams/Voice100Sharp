...
To compile Android native libraries, you need
[Android NDK from Visual Studio 2022](https://learn.microsoft.com/en-us/cpp/cross-platform/install-visual-cpp-for-cross-platform-mobile-development?view=msvc-170).
